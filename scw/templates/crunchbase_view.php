...
<!-- Border to see what it is -->
  ...
  <BR />
  <?php if($this->description != NULL){print '<div class="small-font"> <span class="font_">Description:</span><BR />'.$this->description.'</div>' ;} ?>
    <BR />
  <?php if($this->date_founded != NULL){print '<div class="small-font"> <span class="font_">Date founded:</span> <BR />'.$this->date_founded.'</div>' ;} ?>
