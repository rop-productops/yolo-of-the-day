...
<!-- Border to see what it is -->
  ...
  print '
    <TR>
        <TD style="width: 227px;" class=" border"> 
                ...
                <BR /> 
                    <span class="small-font">
                        '.$this->funding.'
                                    ...
                                    ;} ?>
  <?php if($this->team_total != NULL){print '<td style="width: 225px;" class="border"> <span class="font_">Total employees:</span> <BR /> <span="small-font">'.$this->team_total.'</span> </td></tr>' ;} ?>
